	...
	public function render_cartographie_page() {
		...
		<div class="wrap">
			...
			<div id="sil-graph-wrapper" style="position:relative; height:700px; background:#fff; border:1px solid #ccd0d4; border-radius:8px; overflow:hidden;">
				...
				<!-- Sidebar de détails -->
				<div id="sil-graph-sidebar" class="sil-graph-sidebar" style="display:none; position:absolute; top:10px; right:10px; bottom:10px; width:380px; z-index:1000; background:#fff; border-radius:8px; box-shadow:-5px 0 25px rgba(0,0,0,0.15); border:1px solid #e2e8f0; overflow:hidden; display:flex; flex-direction:column;">
