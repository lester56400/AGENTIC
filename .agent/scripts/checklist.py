...
def print_summary(results: List[dict]):
    ...
    print(f"{Colors.BOLD}{Colors.GREEN}[OK] Passed: {passed_count}{Colors.ENDC}")
    print(f"{Colors.BOLD}{Colors.RED}[ERR] Failed: {failed_count}{Colors.ENDC}")
    if skipped_count > 0:
        print(f"{Colors.BOLD}{Colors.YELLOW}[WARN] Skipped: {skipped_count}{Colors.ENDC}")
    print()
