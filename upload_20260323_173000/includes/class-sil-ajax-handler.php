...
class SIL_Ajax_Handler
{
    ...
    public function sil_get_edge_context() {
        ...
        $pattern = '/<a([^>]+)href=["\'](' . $escaped_url . '|' . $escaped_relative_url . ')["\']([^>]*畅)>(.*?)<\/a>/is';
        ...
        wp_send_json_success([
            ...
            'is_leak' => $is_leak,
            'source_silo' => $silo_labels[$s_silo] ?? "Silo $s_silo",
            'target_silo' => $silo_labels[$t_silo] ?? "Silo $t_silo",
