...
class SmartInternalLinks
{
    ...
    private function __construct()
    {
        ...
        add_action('wp_ajax_sil_get_edge_context', [$ajax_handler, 'sil_get_edge_context']);
        add_action('wp_ajax_sil_toggle_edge_nofollow', [$ajax_handler, 'sil_toggle_edge_nofollow']);
