	...
	public function render_cartographie_page() {
		...
		<div class="sil-pilot-wrap sil-swiss-mode">
			...
			<div class="sil-graph-toolbar-swiss" style="background:#000; padding:10px 20px; display:flex; gap:10px; align-items:center; border:2px solid #000; margin-bottom:20px;">
				...
				<div id="sil-tension-slider-wrap" style="display:none; margin-left:20px; align-items:center; gap:8px;">
					<label for="sil-tension-slider" style="color:#fff; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.05em; white-space:nowrap;">🔴 Tension min</label>
					<input type="range" id="sil-tension-slider" min="0" max="100" value="0" step="5" style="width:120px; accent-color:#ef4444;">
					<span id="sil-tension-value" style="color:#ef4444; font-weight:900; font-family:var(--sil-swiss-mono); font-size:12px; min-width:30px;">0%</span>
				</div>
		...
		<div class="sil-pilot-wrap sil-swiss-mode">
			...
			<div id="pilot-tab-diagnosis" class="pilot-tab-content">
				<div class="glass-card">
					<h3 style="color: var(--lux-accent, #f1f5f9);">🛡️ Auto-Diagnostic Système (v2.5.3)</h3>
